...
<head>
    ...
    <link rel="shortcut icon" href="assets/img/pppbulutuban.png" type="image/x-icon">
                ...
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand">
                        <a href="http://localhost/perpustakaan_upt_ppp_bulu/">
                            <img src="assets/img/pppbulutuban.png" alt="logo" width="120" class="circle">
                        </a>
                    </div>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <form method="POST" action="functions/loginAction.php">
