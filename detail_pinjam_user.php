...
if(isset($_GET['id'])){
    ...
    $query_cek_user = mysqli_query($conn, "SELECT * FROM peminjamans WHERE id = " . $_GET['id']);
    $cek_user = mysqli_num_rows($query_cek_user);
    ...
    $id = $_GET['id'];
    $query_user = mysqli_query($conn, "SELECT * FROM peminjamans INNER JOIN bukus ON peminjamans.id_buku = bukus.id INNER JOIN users ON peminjamans.id_user = users.id WHERE peminjamans.id = " . $id);
    $peminjaman = mysqli_fetch_assoc($query_user);
}else{
    header('Location: dashboard_user.php');
    exit;
}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title section-title-sm position-relative pb-3 mb-4">
                        <h3 class="text-dark mb-0">Detail Peminjaman Buku</h3>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-1">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <?php
                                    if($peminjaman['gambar'] !== 'default.png')
                                    {
                                        ?>
                                        <img src="assets/buku/<?= $peminjaman['gambar']; ?>" alt="gambar buku" width="500" class="img-fluid">
                                    <?php
                                    }
                                    else
                                    {
                                        ?>
                                        <img src="assets/img/news/img01.jpg" alt="gambar buku" width="500" class="img-fluid">
                                        <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="col-md-6 col-sm-12 mb-1">
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-1">
                                    <label for="tujuan" class="form-label"><b>Tanggal Kembali</b></label>
                                    <p><?= $peminjaman['tgl_kembali']; ?></p>
                                </div>
                                <div class="col-md-12 mb-1">
                                    <label for="tujuan" class="form-label"><b>Denda</b></label>
                                ...
                                <div>
                                    <a href="dashboard_user.php" class="btn btn-warning">Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
