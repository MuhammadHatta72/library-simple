                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="post" id="form-id" action="functions/bukuTambahAction.php"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="kode_buku" name="kode_buku" value="<?= 'BK' . date('YmdHis'); ?>" readonly/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea class="form-control"
                                                        id="deskripsi" name="deskripsi" rows="3" style="height: 100px;"></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                                    <label for="kategori" class="form-label">Kategori<span
                                                            class="text-danger">*</span></label>
                                                    <input type="text" class="form-control"
                                                        id="kategori" name="kategori" value="" />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 mb-3">
                                            ...
                                            <input type="hidden" name="tambahBuku" value="Tambah Buku" />
