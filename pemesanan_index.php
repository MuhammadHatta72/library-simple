                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="float-right mb-3">
                                            <a class="btn btn-success border-0 text-white createBtn" href="pemesanan_tambah.php">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="tablePaging">
                                                ...
                                                <tbody>
                                                    <?php
                                                    foreach ($query_hasil_peminjaman as $peminjaman){
                                                    ?>
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <form action="functions/pemesananProses.php" method="post"
                                                                        onsubmit="return confirm('Apakah anda yakin ingin memproses peminjaman ini?')">
                                                                        <input type="hidden" name="id_peminjaman"
                                                                            value="<?= $peminjaman['id_peminjaman']; ?>">
                                                                        <input type="hidden" name="prosesPemesanan"
                                                                            value="true">
                                                            ...
                                                            <td class="d-flex justify-content-center gap-1 align-items-center">
                                                                <a class="btn btn-warning text-white showBtn"
                                                                    href="pemesanan_show.php?id=<?= $peminjaman['id_peminjaman']; ?>">
                                                                    <i class="fas fa-eye"></i>
                                                                </a>
                                                                <?php
                                                                    if ($peminjaman['status'] == 'dipinjam') {
                                                                ?>
                                                                    <form action="functions/pemesananKembaliAction.php" method="post"
                                                                        onsubmit="return confirm('Apakah anda yakin ingin mengembalikan buku ini?')">
                                                                        <input type="hidden" name="id_peminjaman"
                                                                            value="<?= $peminjaman['id_peminjaman']; ?>">
                                                                        <input type="hidden" name="kembalikanPemesanan"
                                                                            value="true">
